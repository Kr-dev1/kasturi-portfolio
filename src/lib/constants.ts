...
export const SITE_KEYWORDS = ['Kasturi Ragnan', 'Next.js', 'React', 'TypeScript', 'Node.js', 'Express', 'MongoDB', 'PostgreSQL', 'MySQL', 'Firebase', 'Drizzle', 'Cloudflare', 'Vite', 'Vitest', 'Node.js', 'React Query', 'Tailwind CSS', 'Radix UI', 'Shadcn UI', 'Ant Design', 'Material UI', 'Bootstrap', 'Chakra UI', 'Tailwind CSS', 'Radix UI', 'Shadcn UI', 'Material UI', 'Bootstrap']
